...
TRAIN_DATA_LOCATION = {cstrcat('datiQ-20160509/dataset', DATASIZE, '/', NODES, 'nodes/fetched/', QUERY, '/data/')};
...
OUTPUT_LATEX = true;
TABLE_CAPTION = cstrcat('Results for ', QUERY, '-', DATASIZE, 'GB with ', NODES, ' nodes');
PLOT_CAPTION = cstrcat('Completion time vs ncores for query ', QUERY, ' ', NODES, 'nodes with datasize ', DATASIZE);
...
OUTPUT_FOLDER = strcat('output/', QUERY, '_', NODES, 'nodes_', DATASIZE, '_ALL_FEATURES/');
